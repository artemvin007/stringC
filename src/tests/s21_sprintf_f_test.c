...
START_TEST(sprintf_1_f) {
  char *str1 = calloc(200, sizeof(char));
  char *str2 = calloc(200, sizeof(char));
...
START_TEST(sprintf_3_f) {
  char *str1 = calloc(400, sizeof(char));
  char *str2 = calloc(400, sizeof(char));
  char *str3 = "%Lf\n%.Lf!";
...
START_TEST(sprintf_48_f) {
  ...
  char *str2 = calloc(400, sizeof(char));
  char *str3 = "test: %.1Lf!\ntest: %.2Lf!\ntest: %.3Lf!";
  long double num = 82363107597383.6495633;
  ck_assert_int_eq(sprintf(str1, str3, num, num, num),
                   s21_sprintf(str2, str3, num, num, num));
  ck_assert_pstr_eq(str1, str2);
  free(str1);
...
START_TEST(sprintf_49_f) {
  ...
  char *str2 = calloc(400, sizeof(char));
  char *str3 = "test: %+ 0Lf!\ntest: %.6Lf!\ntest: %.15Lf!";
  long double num = 8236310759733.6495633;
  ck_assert_int_eq(sprintf(str1, str3, num, num, num),
                   s21_sprintf(str2, str3, num, num, num));
  ck_assert_pstr_eq(str1, str2);
  free(str1);
...
Suite *s21_sprintf_f_suite(void) {
  Suite *s = suite_create("\033[103m21_SPRINTF_F\033[0m");
